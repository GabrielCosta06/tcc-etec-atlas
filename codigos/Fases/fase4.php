...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['respostaUsuario'])) {
    ...
    if (isset($_COOKIE['timer']) && $_COOKIE['timer'] > 0) {
        $respostasCorretas = ['estamos em toda parte', 'estamos por toda parte'];
            ...
            <div class="navbar">
                <div class="resposta">
                    <form action="fase4.php" method="post">
                        <input type="text" name="respostaUsuario" autocomplete="off" placeholder="Dica: Onde estamos?">
        ...
        <div id="mainModal" class="modal">
            <div class="modal-content">
                ...
                <div class="txtModalDia2">
                    ...
                    braços, percebi uma enigmática marca da qual não fazia a menor ideia do significado.<br><br>
                    
                    Apenas sei que são 21.
                </div>
            </div>
        </div>
