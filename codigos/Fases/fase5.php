...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['respostaUsuario'])) {
    ...
    if (isset($_COOKIE['timer']) && $_COOKIE['timer'] > 0) {
        $respostasCorretas = ['seja bem vindo ao realinismo', 'bem vindo ao realinismo'];
            ...
            <div class="navbar">
                <div class="resposta">
                    <form action="fase5.php" method="post">
                        <input type="text" name="respostaUsuario" autocomplete="off" placeholder="Dica: Bem vindo?">
            ...
            <div id="mainModal" class="modal">
                <div class="modal-content">
                    ...
                    <div class="txtModalDia2">
                        ...
                        perturbadores que me assombravam. Enquanto seguia em direção ao seu consultório, deparei-me com
                        uma
                        multidão de pessoas vestidas de modo obscuro e macabro, evocando imediatamente a lembrança
                        sinistra
                        ...
                        percebi que todos aqueles indivíduos começaram a me perseguir, suas faces ocultas pela
                        escuridão.
                        Com a mente tomada pelo pânico, só havia uma opção: fugir daquele pesadelo. Foi quando me
                        encontrava
                        nas imediações do bairro onde Afonso residia. Sem hesitar, decidi procurar refúgio em seu
                        apartamento. No entanto, ao chegar, deparei-me com a porta entreaberta, indiciando algo terrível
                        que
                        havia ocorrido.<br><br>

                        Subitamente, uma figura sombria e indistinta avançou em minha direção, congelando-me de medo. Em
                        um
                        ato desesperado, corri em direção à cozinha, buscando qualquer coisa que pudesse me proteger,
                        peguei
                        o primeiro objeto que consegui ver, uma faca, fui em sua direção e coloquei próximo a sua
                        garganta,
                        me lembro dele me chamando de louco e gritando por socorro, mas enquanto ele gritava mais, eu
                        tinha
                        terminado, cortei sua garganta. Quando percebi ele caindo sobre meus braços percebi a loucura
                        que
                        tinha feito, na hora o medo e um desespero tomou conta de mim, pois se tratava de meu melhor
                        amigo,
                        Afonso. De alguma maneira tinha que me livrar daquele corpo antes que alguém notasse a falta
                        dele.
                        Mas vendo aquele sangue disperso pela sala me deu fome, foi aí que despertou um desejo, dividir
                        em
                        porções para guardar e saborear mais tarde.<br><br>

                        Após ter consumado o ato, uma inegável sensação de irrevogabilidade tomou conta de mim. Foi
                        então
                        que me veio à mente a visão da figura enigmática, vestida de preto, que havia profetizado seu
                        desejo
                        de usar-me como instrumento para aplacar sua fome insaciável. Aterrorizado, compreendi que eu
                        havia
                        ...
                        Diante de todos esses fatos, em minha mente se passava uma melodia ressoando em meus mais
                        profundos
